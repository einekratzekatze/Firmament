package moe.nea.notfimament.compat.rei
...
import moe.nea.notfimament.compat.rei.recipes.GenericREIRecipeCategory
import moe.nea.notfimament.compat.rei.recipes.SBKatRecipe
import moe.nea.notfimament.compat.rei.recipes.SBMobDropRecipe
import moe.nea.notfimament.compat.rei.recipes.SBRecipe
import moe.nea.notfimament.compat.rei.recipes.SBReforgeRecipe
import moe.nea.notfimament.compat.rei.recipes.SBShopRecipe
import moe.nea.notfimament.events.HandledScreenPushREIEvent
import moe.nea.notfimament.features.inventory.CraftingOverlay
...
import moe.nea.notfimament.util.guessRecipeId
import moe.nea.notfimament.util.skyblockId
...
class FirmamentReiPlugin : REIClientPlugin {
	...
	companion object {
		...
		val SKYBLOCK_ITEM_TYPE_ID = Identifier.fromNamespaceAndPath("notfimament", "skyblockitems")
	}
