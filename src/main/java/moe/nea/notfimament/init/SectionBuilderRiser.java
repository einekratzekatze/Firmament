...
public class SectionBuilderRiser extends RiserUtils {
	...
	String CustomBlockTextures = "moe.nea.notfimament.features.texturepack.CustomBlockTextures";
	...
	private void handleIndigo(MethodNode method) {
		...
		if (blockPosVar == null || blockStateVar == null) {
			System.err.println("Notfimament could inject into indigo: missing either block pos or blockstate");
			return;
		}
