...
import moe.nea.notfimament.events.EarlyResourceReloadEvent
...
import moe.nea.notfimament.features.texturepack.CustomBlockTextures.createBakedModels
import moe.nea.notfimament.features.texturepack.CustomGlobalTextures.logger
import moe.nea.notfimament.util.ErrorUtil
import moe.nea.notfimament.util.IdentifierSerializer
import moe.nea.notfimament.util.MC
import moe.nea.notfimament.util.SBData
import moe.nea.notfimament.util.SkyBlockIsland
import moe.nea.notfimament.util.json.BlockPosSerializer
import moe.nea.notfimament.util.json.SingletonSerializableList
...
object CustomBlockTextures {
	...
	private val sodiumReloadTask = runCatching {
		val r = Class.forName("moe.nea.notfimament.compat.sodium.SodiumChunkReloader")
			.getConstructor()
	...
	/**
	 * Used by [moe.nea.notfimament.init.SectionBuilderRiser]
	 */
