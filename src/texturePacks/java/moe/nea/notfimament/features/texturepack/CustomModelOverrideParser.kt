...
import moe.nea.notfimament.features.texturepack.predicates.AndPredicate
import moe.nea.notfimament.features.texturepack.predicates.CastPredicate
import moe.nea.notfimament.features.texturepack.predicates.DisplayNamePredicate
import moe.nea.notfimament.features.texturepack.predicates.ExtraAttributesPredicate
import moe.nea.notfimament.features.texturepack.predicates.GenericComponentPredicate
import moe.nea.notfimament.features.texturepack.predicates.ItemPredicate
import moe.nea.notfimament.features.texturepack.predicates.LorePredicate
import moe.nea.notfimament.features.texturepack.predicates.NotPredicate
import moe.nea.notfimament.features.texturepack.predicates.OrPredicate
import moe.nea.notfimament.features.texturepack.predicates.PetPredicate
import moe.nea.notfimament.features.texturepack.predicates.PullingPredicate
import moe.nea.notfimament.features.texturepack.predicates.SkullPredicate
...
object CustomModelOverrideParser {
	...
	fun registerPredicateParser(name: String, parser: FirmamentModelPredicateParser) {
		predicateParsers[Identifier.fromNamespaceAndPath("notfimament", name)] = parser
	}
	...
	fun parsePredicates(predicates: JsonObject?): List<FirmamentModelPredicate> {
		...
		for (predicateName in predicates.keySet()) {
			...
			if (!predicateName.startsWith("notfimament:")) continue
