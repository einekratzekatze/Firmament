...
class CompatMetaProcessor(val logger: KSPLogger, val codeGenerator: CodeGenerator, val sourceSetName: String) :
	...
	override fun process(resolver: Resolver): List<KSAnnotated> {
		...
		packages.add("moe.nea.notfimament.annotations.generated.$sourceSetName")
		val compatMeta = resolver.getSymbolsWithAnnotation("moe.nea.notfimament.util.compatloader.CompatMeta")
		...
		val compatFile =
			codeGenerator.createNewFile(dependencies, "moe.nea.notfimament.annotations.generated.$sourceSetName", generatedFileName)
				.bufferedWriter()
		compatFile.appendLine("// This file is @generated by SubscribeAnnotationProcessor")
		compatFile.appendLine("// Do not edit")
		compatFile.appendLine("package moe.nea.notfimament.annotations.generated.$sourceSetName")
		compatFile.appendLine("class $generatedFileName : moe.nea.notfimament.util.compatloader.ICompatMetaGen {")
		compatFile.appendLine("""
	override fun owns(className: String): Boolean {
		return moe.nea.notfimament.util.compatloader.CompatHelper.isOwnedByPackage(className, ${
			packages.joinToString { "\"" + it + "\"" }
		})
	}

	override val meta: moe.nea.notfimament.util.compatloader.ICompatMeta
...
""")
		...
		val metaInf = codeGenerator.createNewFileByPath(
			dependencies,
			"META-INF/services/moe.nea.notfimament.util.compatloader.ICompatMetaGen", extensionName = "")
			.bufferedWriter()
		metaInf.append("moe.nea.notfimament.annotations.generated.$sourceSetName.")
