...
class SubscribeAnnotationProcessor(
    ...
    override fun finish() {
        ...
        val subscriptionsFile =
            codeGenerator
                .createNewFile(dependencies, "moe.nea.notfimament.annotations.generated.$sourceSetName", generatedFileName)
                .bufferedWriter()
        subscriptionsFile.apply {
            appendLine("// This file is @generated by SubscribeAnnotationProcessor")
            appendLine("// Do not edit")
            appendLine("package moe.nea.notfimament.annotations.generated.$sourceSetName")
            appendLine()
            appendLine("import moe.nea.notfimament.events.subscription.*")
            appendLine()
	        appendLine("@Suppress()")
        ...
        val metaInf = codeGenerator.createNewFileByPath(
            dependencies,
            "META-INF/services/moe.nea.notfimament.events.subscription.SubscriptionList", extensionName = "")
            .bufferedWriter()
